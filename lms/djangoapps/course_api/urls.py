...
from .views import CourseDetailView, CourseIdListView, CourseListView, CourseMentorsView

urlpatterns = [
    path('v1/courses/', CourseListView.as_view(), name="course-list"),
    re_path(fr'^v1/courses/{settings.COURSE_KEY_PATTERN}/mentors/?$', CourseMentorsView.as_view(), name="course-mentors"),
